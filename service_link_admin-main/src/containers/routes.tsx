...
const routes = [
	...
	{ path: 'safety-audit-templates', component: asyncComponent(() => import('@app/containers/safety-audit-templates')) },
	...
	{ path: 'safety-audits', component: asyncComponent(() => import('@app/containers/reports/safety-audits')) },
	...
	{ path: 'training', component: asyncComponent(() => import('@app/containers/training')) },
	{ path: 'training-admin', component: asyncComponent(() => import('@app/containers/training/admin')) },
