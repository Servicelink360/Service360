...
const DEFAULT_VALUE_TYPES = ['TEXT', 'TEXTAREA', 'RICH_TEXT', 'NUMBER', 'PERCENTAGE', 'CURRENCY', 'DATE', 'TIME', 'DATETIME', 'SELECT', 'CHECKLIST']
const STAFF_VISIBILITY_TYPES = ['DATE', 'TIME', 'DATETIME', '[REPORT_DATE]', '[REPORT_TIME]', '[REPORT_DATETIME]']
