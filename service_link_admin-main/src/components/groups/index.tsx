...
import {
    ...
    Fieldset,
    FooterModalWrap} from '@app/components/common/Common.styles'
...
import InputNumberForm from '@app/components/common/FormItem/InputNumber'
...
const Index = (props: IProps) => {
    const { modalType, isSuccess, loadingAction, data, title, isAnother = false ,getDataInit, services} = props
