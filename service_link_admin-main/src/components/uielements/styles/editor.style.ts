...
const { palette, font } = styledTheme;

const QuillEditor = styled.div`
  .ql-editor {
    min-height: 215px;
    text-align: ${(props: any) => (props['data-rtl'] === 'rtl' ? 'right' : 'left')};
  }
  ...
  .ql-container.ql-snow {
    ...
    props['data-rtl'] === 'rtl' ? '0 8px 0 2px' : '0 2px 0 8px'};
      ...
      &:not(.ql-color-picker):not(.ql-icon-picker) {
        svg {
          right: ${(props: any) => (props['data-rtl'] === 'rtl' ? 'inherit' : '0')};
          left: ${(props: any) => (props['data-rtl'] === 'rtl' ? '0' : 'inherit')};
        }
      }
    }
  }
