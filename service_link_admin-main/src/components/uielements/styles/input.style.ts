...
const InputWrapper = (ComponentName: any) => styled(ComponentName)`
  &.ant-input {
    padding: 4px 10px;
    width: 100%;
    height: 35px;
...
`;
const InputGroupWrapper = (ComponentName: any) => styled(ComponentName)`
  &.ant-input-group {
    margin-bottom: 10px;
...
const TextAreaWrapper = (ComponentName: any) => styled(ComponentName)`
  &.ant-input {
    padding: 4px 10px;
    width: 100%;
    height: auto;
...
const InputSearchWrapper = (ComponentName: any) => styled(ComponentName)`
