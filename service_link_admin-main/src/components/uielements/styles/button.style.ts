...
import { transition } from '@app/lib/helpers/style_utils';
const styledTheme = require('styled-theme');
const { palette } = styledTheme;
const Buttons = (ComponentName: any) => styled(ComponentName)`
  &.ant-btn {
    ...
    &.ant-btn-secondary {
      ...
      color: #fff;
      &:hover {
        background-color: ${palette('secondary', 10)}8c;
        border-color: ${palette('secondary', 10)}8c;
        color: #fff;
      }
    }
    &.ant-btn-sm {
...
const RadioButtons = (ComponentName: any) => styled(ComponentName)`
...
const ButtonsGroup = (ComponentName: any) => styled(ComponentName)`
  &.ant-btn-group {
    .ant-btn {
      margin: 0;
      margin-right: 0;
...
const GhostButtons = (ComponentName: any) => styled(ComponentName)`
  .ant-btn-background-ghost {
