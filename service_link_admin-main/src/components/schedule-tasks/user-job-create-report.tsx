...
import DatePickerForm from '@app/components/common/FormItem/DatePicker'
import UploadImageMultil from '@app/components/common/upload-image-multi'
    ...
    const ActionBTN = () => {
        return (<>
            <ActionHeaderModalWrap>
                {
                    (modalType !== actionType.VIEW || (modalType === actionType.VIEW && data.items.length === 0)) &&
                    <ActionBtn
                        type="primary"
                        icon={<SaveOutlined />}
                        onClick={() => {
